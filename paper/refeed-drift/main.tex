...
\begin{enumerate}
  ...
  pivots in the five stock-engine runs, 3{,}829 including the
...
component). The decomposition, conditioning, clustered, selection, and
...
Greedy cont.\ (t=0, K1)$^{\diamond}$ & Qwen2.5-7B-Inst & 189 & 40.2\% (0.5) & 13.8\% (0.0) & $+26.5$ & 3.64 & 5.66 \\
...
(pooled bias $-0.011$, $t=-1.23$, 95\% CI $[-0.029, +0.007]$), so quantities that average many pivots
...
To be precise about the mechanism: every selection disagreement we observe
sits within one grading quantum ($1/K$) of the threshold, and the re-feed
...
with re-feeding consuming a further third to two-thirds of the remaining
headroom.
